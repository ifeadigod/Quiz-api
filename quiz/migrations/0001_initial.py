# Generated by Django 4.0.5 on 2022-06-18 01:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='New_Quiz', max_length=225, verbose_name='Quiz_Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_uodated', models.DateTimeField(auto_now=True, verbose_name='Last Updated')),
                ...
                ('difficulty', models.IntegerField(choices=[(0, 'Fundamental'), (1, 'Beginner'), (2, 'Intermidiate'), (3, 'Advanced'), (4, 'Expert')], default=0, verbose_name='Difficulty')),
